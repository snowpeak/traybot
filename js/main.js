...
function createAccountListWin() {
    ...
    p_win.setMenu(null);
    p_win.loadURL( `file://${__dirname}/../html/accountList.html`);
...
function createEditAccountWin(x_account) {
    ...
    p_win.setMenu(null);
    p_win.loadURL( `file://${__dirname}/../html/editAccount.html`);
...
function createShowAccountWin(x_account) {
    ...
    if( s_showAccountWin == null){
        ...
        p_win.setMenu(null);
        p_win.loadURL( `file://${__dirname}/../html/showAccount.html`);
